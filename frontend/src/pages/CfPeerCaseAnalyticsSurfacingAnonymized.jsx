...
// Auto-generated page for: Peer case analytics surfacing anonymized success patterns an

export default function CfPeerCaseAnalyticsSurfacingAnonymized() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-peer-case-analytics-surfacing-anonymized', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Peer case analytics surfacing anonymized success patterns an</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Peer case analytics surfacing anonymized success patterns and strategy recommendations.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Peer case analytics surfacing anonymized success patterns an'}
        </button>
      </form>
