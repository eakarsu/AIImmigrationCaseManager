...
// Auto-generated page for: No client portal (status tracking, document submission)

export default function GapNoClientPortalStatusTrackingDocumen() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-client-portal-status-tracking-documen', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No client portal (status tracking, document submission)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No client portal (status tracking, document submission)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No client portal (status tracking, document submission)'}
        </button>
      </form>
