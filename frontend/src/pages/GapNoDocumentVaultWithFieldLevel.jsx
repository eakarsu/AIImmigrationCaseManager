...
// Auto-generated page for: No document vault with field-level encryption

export default function GapNoDocumentVaultWithFieldLevel() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-document-vault-with-field-level', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No document vault with field-level encryption</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No document vault with field-level encryption</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No document vault with field-level encryption'}
        </button>
      </form>
