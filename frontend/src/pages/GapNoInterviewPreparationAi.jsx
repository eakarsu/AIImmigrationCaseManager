...
// Auto-generated page for: No interview preparation AI

export default function GapNoInterviewPreparationAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-interview-preparation-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No interview preparation AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No interview preparation AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No interview preparation AI'}
        </button>
      </form>
