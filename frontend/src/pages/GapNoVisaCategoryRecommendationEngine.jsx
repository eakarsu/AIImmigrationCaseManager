...
// Auto-generated page for: No visa-category recommendation engine

export default function GapNoVisaCategoryRecommendationEngine() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-visa-category-recommendation-engine', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No visa-category recommendation engine</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No visa-category recommendation engine</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No visa-category recommendation engine'}
        </button>
      </form>
