...
// Auto-generated page for: No RFE auto-response drafter

export default function GapNoRfeAutoResponseDrafter() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-rfe-auto-response-drafter', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No RFE auto-response drafter</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No RFE auto-response drafter</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No RFE auto-response drafter'}
        </button>
      </form>
