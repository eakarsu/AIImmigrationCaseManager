...
// Auto-generated page for: No multilingual translation routing

export default function GapNoMultilingualTranslationRouting() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-multilingual-translation-routing', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No multilingual translation routing</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No multilingual translation routing</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No multilingual translation routing'}
        </button>
      </form>
