...
// Auto-generated page for: Agentic case manager auto-generating documents, tracking sta

export default function CfAgenticCaseManagerAutoGeneratingDoc() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-case-manager-auto-generating-doc', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Agentic case manager auto-generating documents, tracking sta</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Agentic case manager auto-generating documents, tracking status, and sending deadline reminders.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Agentic case manager auto-generating documents, tracking sta'}
        </button>
      </form>
