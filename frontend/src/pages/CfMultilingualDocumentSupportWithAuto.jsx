...
// Auto-generated page for: Multilingual document support with auto-detection and transl

export default function CfMultilingualDocumentSupportWithAuto() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multilingual-document-support-with-auto-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Multilingual document support with auto-detection and transl</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Multilingual document support with auto-detection and translation routing.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Multilingual document support with auto-detection and transl'}
        </button>
      </form>
